  ...
  fetch(`${url}/budgetcal`, {
    ...
    .then((data) => {
      ...
      table.children[1].children[1].children[2].children[0].value =
        data.Expense.groc;
      let total1 = data.Budget.groc - data.Expense.groc;
      ...
      table.children[1].children[4].children[2].children[0].value =
        data.Expense.shop;
      let total4 = data.Budget.shop - data.Expense.shop;
      ...
      table.children[1].children[9].children[2].children[0].value =
        data.Expense.inv;
      let total9 = data.Budget.inv - data.Expense.inv;
